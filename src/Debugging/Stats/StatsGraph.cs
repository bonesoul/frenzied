...
namespace Frenzied.Debugging.Stats
{
    using System;
    using System.Collections.Generic;
    using System.Linq;
    ...
    namespace VoxeliqStudios.Voxeliq.Debugging
    {
        ...
        public class StatisticsGraphs : DrawableGameComponent
        {
            ...
            public Rectangle PerformancePanelBounds;
            ...
            public override void Initialize()
            {
                ...
                this.PerformancePanelBounds = new Rectangle(this.Game.GraphicsDevice.Viewport.Bounds.Width - 210, 10, 200, 35);
